...
public class ShoppingBill {
	public static void main(String args[]) {
		...
		System.out.println("\t\t\t\t\t3/26, K M Saha Street, Serampore, Serampore - 712201");
		System.out.println("\t\t\t\t\t" + "    " + "(Opposite P C Chandra Jewellery)");
		System.out.println("GSTIN: 03AWBPP8756K592" + "\t\t\t\t\t\t\tContact: (+91) 7980984860");
